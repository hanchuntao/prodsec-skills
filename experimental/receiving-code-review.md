...
IF conflicts with prior architectural decisions:
  Stop and discuss with the code author first
```
...
If a feature is not needed, do not add it — regardless of who suggests it.
...
- Involve the code author if architectural
